  ...
  return (
    <div className="admin-dashboard-page">
      <div className="pending-wrap">
        ...
        <h1 className="pending-title">Pending user approvals</h1>
        <p className="pending-subtitle">
          User accounts with vendor registrations awaiting approval.
        </p>
        ...
        {items && items.length === 0 && !error ? (
          <p className="pending-empty">No users pending approval.</p>
        ) : null}
